...
import { Choice, ChoiceFactoryOptions } from 'botbuilder-dialogs/src/choices';
import { Dialog, DialogInstance, DialogReason, DialogTurnResult, DialogEvent } from 'botbuilder-dialogs/src/dialog';

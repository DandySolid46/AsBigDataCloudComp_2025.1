...
import { AuthenticateRequestResult } from 'botframework-connector/src/auth/authenticateRequestResult';
import type { BotFrameworkClient } from 'botframework-connector/src/skills';
import { ClaimsIdentity } from 'botframework-connector/src/auth/claimsIdentity';
import type { ConnectorFactory } from 'botframework-connector/src/auth/connectorFactory';
import type { ServiceClientCredentialsFactory } from 'botframework-connector/src/auth/serviceClientCredentialsFactory';
import type { UserTokenClient } from 'botframework-connector/src/auth/userTokenClient';
/**
